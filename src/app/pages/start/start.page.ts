        ...
        <div class="form-section">
          ...
          <form [formGroup]="form" (ngSubmit)="onLogin()" novalidate>
            ...
            <div class="field" [class.has-error]="emailTouched() && emailError()">
              <label class="inka-field-label" for="email">Email</label>
              <div class="inka-field-input">
                <svg class="inka-field-icon" width="20" height="20" viewBox="0 0 24 24" fill="none">
                  <rect
                    x="2"
                    y="4"
                    width="20"
              ...
              @if (emailTouched() && emailError()) {
                <span class="inka-field-error" id="email-error">{{ emailError() }}</span>
              }
            </div>

            <!-- Password -->
            <div class="field" [class.has-error]="passwordTouched() && !passwordValid()">
              <label class="inka-field-label" for="password">Password</label>
              <div class="inka-field-input">
                @if (passwordValid()) {
                  <svg
                    class="inka-field-icon valid"
                    width="20"
                    height="20"
                    viewBox="0 0 24 24"
                    fill="none"
